...
class _PlayerHomeScreenState extends State<PlayerHomeScreen> {
  ...
  void initState() {
    ...
    _liveCatalogService.startRealtimeSync(
      onCatalogChanged: _refreshLivePreviewSilently,
    );
      ...
      child: Column(
        ...
        children: [
          ...
          if (_livePreviewLoading)
            ...
            _livePreviewStreams.isEmpty
                ? Padding(
                    padding: const EdgeInsets.symmetric(vertical: 28),
                    child: Center(
                      child: Text(
                        _livePreviewErrorMessage ?? 'No live streams right now.',
