        ...
        children: [
          Row(
            ...
            children: [
              Row(
                children: [
                  Text(game, style: const TextStyle(color: Colors.white, fontSize: 13, fontWeight: FontWeight.bold)),
                  const SizedBox(width: 8),
                  Text(
                    result,
                    style: TextStyle(
              ...
              Text(timeAgo, style: const TextStyle(color: Color(0xFF7A86AC), fontSize: 12)),
            ],
          ),
          const SizedBox(height: 16),
          Row(
            ...
            children: [
              _buildLargeStat('Score', score),
              _buildLargeStat('K/D/A', kda),
            ],
          ),
        ],
      ),
