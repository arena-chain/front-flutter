...
class Dota2StatsScreen extends StatefulWidget {
  const Dota2StatsScreen({super.key});

  @override
  State<Dota2StatsScreen> createState() => _Dota2StatsScreenState();
}

class _Dota2StatsScreenState extends State<Dota2StatsScreen> {
          ...
          if (s.steamAvatarUrl != null && s.steamAvatarUrl!.isNotEmpty)
            ClipRRect(
              ...
              child: Image.network(
                ...
                height: 64,
                fit: BoxFit.cover,
                errorBuilder: (_, __, ___) => _dotaPlaceholder(),
              ),
            )
          else
            _dotaPlaceholder(),
  ...
  Widget _dotaPlaceholder() {
    return Container(
      ...
      child: const Center(
        child: Text(
          'DOTA',
          style: TextStyle(color: _neon, fontWeight: FontWeight.w900, fontSize: 12),
        ),
      ),
    );
  }
    ...
    return Container(
      ...
      child: const Column(
        ...
        children: [
          ...
          SizedBox(height: 10),
          Text(
            'Dota 2 match history and MMR-style summaries will appear here once the platform exposes the Steam Web API (Dota 2 match history / player summaries).',
