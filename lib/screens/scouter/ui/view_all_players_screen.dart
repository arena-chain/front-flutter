...
class _ViewAllPlayersScreenState extends State<ViewAllPlayersScreen> {
  ...
  List<PlayerDetail> get _filtered {
    ...
    return _all.where((p) => (p.userId?.nickname ?? '').toLowerCase().contains(q)).toList();
  }
        ...
        child: ClipRRect(
          ...
          child: BackdropFilter(
            ...
            child: Material(
              ...
              child: InkWell(
                onTap: () {
                  final playerId = p.effectiveUserId.isNotEmpty ? p.effectiveUserId : p.id;
